...
// Ignore Spelling: Prantl websitefolder outputfolder localizedfolder projectname tocfile maxdegreeofparallelism
...
namespace SandcastleBuilder.HtmlExtract
{
    ...
    /// </summary>
    public static class SandcastleHtmlExtractCore
    {
        ...
        /// <summary>
        /// This is used internally to indicate whether this is running as console mode application (false)
        /// or as an MSBuild task (true).
        /// </summary>
        internal static bool IsMSBuildTask { get; set; }
                ...
                foreach(OptionInfo option in options)
                {
                    ...
                    switch(option.Name)
                    {
                        ...
                        case "maxdegreeofparallelism":
                            if(!Int32.TryParse(option.Value, out maxDegreeOfParallelism))
                                throw new ArgumentException("Invalid maximum degree of parallelism value");
