...
/// encoding issues encountered when building HTML Help 1 (.chm) files for various foreign languages.
/// </summary>
/// <remarks>This uses the
/// <see href="https://github.com/EWSoftware/SHFB/blob/master/ThirdPartyTools/SBAppLocale_ENG.zip">Steel
/// Bytes SBAppLocale</see> tool to run the HTML Help 1 compiler using the correct locale.</remarks>
[HelpFileBuilderPlugInExport("DBCS Fix for CHM Builds", Version = AssemblyInfo.ProductVersion,
  Copyright = AssemblyInfo.Copyright + "\r\nSBAppLocale is Copyright \xA9 2005-2026 Steel Bytes, All Rights Reserved",
