...
namespace SandcastleBuilder.Gui
{
	...
	/// </summary>
    /// <remarks>The window placement functions are used so as to support restoring the window on multi-monitor
    /// systems.</remarks>
	...
	internal static class UnsafeNativeMethods
	{
        ...
        /// <returns>A short containing the virtual-key code in the low order byte and the shift state in the
        /// high order byte.</returns>
        [DllImport("user32.dll")]
        private static extern short VkKeyScan(char ch);
 
        /// <summary>
        /// This is used to convert a <see cref="Char" /> value to a <see cref="Keys" /> value.
        /// </summary>
        /// <param name="ch">The character to convert</param>
        /// <returns>The <see cref="Keys" /> value corresponding to the character.  Note that not all keys are
        /// represented in the <c>Keys</c> enumeration.  Some may return rather odd combinations or no actual
        /// enumerated value at all.</returns>
