...
public partial class TopicEditorWindow : BaseContentEditor
{
    ...
    public override bool CanClose
    {
        get
        {
            ...
            DialogResult dr = MessageBox.Show("Do you want to save your changes to '" + this.ToolTipText +
                "?  Click YES to save them, NO to discard them, or CANCEL to stay here and make " +
    ...
    public override bool SaveAs()
    {
        ...
        dlg.Filter = "Project Files (*.md, *.aml, *.htm*, *.css, *.js, *.content, *.sitemap, " +
            "*.snippets, *.tokens, *.items)|*.md;*.aml;*.htm*;*.css;*.js;*.content;*.sitemap;*.tokens;" +
            "*.snippets;*.items|Content Files (*.md, *.aml, *.htm*)|*.md;*.aml;*.htm*|Content Layout Files " +
    ...
    private void InsertTopicLink(string extension, Topic topic)
    {
        ...
        else
        {
            if(extension.Equals(".md", StringComparison.OrdinalIgnoreCase))
                ContentEditorControl.InsertString(textArea, topic.ToMarkdownLink(selectedText));
            else
    ...
    private void editor_DragDrop(object sender, DragEventArgs e)
    {
        ...
        Topic topic;
        TocEntry tocEntry;
        string extension = Path.GetExtension(this.ToolTipText);
