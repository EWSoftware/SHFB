...
// 04/12/2008  EFW  Added support for splitting the table of contents
// 09/04/2008  EFW  Reworked for use with the new project format
// 12/21/2011  EFW  Rewrote to use the shared WPF Site Map Editor user control
//===============================================================================================================
...
namespace SandcastleBuilder.Gui.ContentEditors
{
    ...
    public partial class SiteMapEditorWindow : BaseContentEditor
    {
        ...
        private void cmdEdit_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            TocEntry t = sender as TocEntry ?? ucSiteMapEditor.CurrentTopic;
        ...
        private void cmdAddFromTemplate_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            using SelectFileTemplateDlg dlg = new(false, newFilePath);
