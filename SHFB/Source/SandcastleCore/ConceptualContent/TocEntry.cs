...
namespace Sandcastle.Core.ConceptualContent
{
    ...
    public class TocEntry : IComparable<TocEntry>, ICloneable, INotifyPropertyChanged
    {
        ...
        public FilePath SourceFile
        {
            ...
            {
                if(value == null)
                    field = new FilePath(this.BasePathProvider);
                else
                    field = value;
            }
        }
        ...
        public TocEntry(IBasePathProvider basePathProvider)
        {
            ...
            this.SourceFile = new FilePath(basePathProvider);
        ...
        public void LoadSiteMapNode(XmlNode site)
        {
            ...
            if(site != null)
            {
                ...
                if(site.Attributes["url"] == null)
                    this.SourceFile = new FilePath(this.BasePathProvider);
                else
                    this.SourceFile = new FilePath(site.Attributes["url"].Value, this.BasePathProvider);
        ...
        public void SaveAsSiteMapNode(XmlNode root)
        {
            ...
            if(this.SourceFile.Path.Length == 0)
                attr.Value = String.Empty;
            else
                attr.Value = this.SourceFile.PersistablePath;
        ...
        public TocEntry ContainsMatch(string sourceFilename)
        {
            ...
            if(this.SourceFile == sourceFilename)
                return this;
