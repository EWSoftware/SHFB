...
namespace Sandcastle.Core.ConceptualContent
{
    ...
    public class TokenCollection : BindingList<Token>
    {
        ...
        /// </summary>
        /// <remarks>Values are sorted by token name and value.  Comparisons are case-sensitive.</remarks>
        public void Sort()
        {
        ...
        public void Save()
        {
            using var writer = XmlWriter.Create(this.TokenFilePath, new XmlWriterSettings
            {
                Indent = true,
                CloseOutput = true
            });
