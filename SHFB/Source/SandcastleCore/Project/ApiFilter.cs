    ...
    public class ApiFilter : IComparable<ApiFilter>
    {
        ...
        public string FilterName
        {
            ...
            set
            {
                ...
                if(field.IndexOf('(') != -1 || field.IndexOf("``", StringComparison.Ordinal) != -1)
                {
        ...
        internal void ConvertToString(StringBuilder sb)
        {
            ...
            if(this.EntryType != ApiEntryType.None)
            {
                ...
                sb.Append(HttpUtility.HtmlEncode(this.FilterName));
        ...
        internal void ToXml(XmlTextWriter xw)
        {
            ...
            if(this.FilterName != this.FullName)
                xw.WriteAttributeString("filterName", this.FilterName);
