...
namespace Sandcastle.Core.PresentationStyle.Transformation.Elements.Markdown
{
    ...
    public class MarkdownElement : Element
    {
        ...
        public MarkdownElement(string name, string prefixSyntax, string suffixSyntax, string fallbackElement) : base(name)
        {
        ...
        public override void Render(TopicTransformationCore transformation, XElement element)
        {
            ...
            // Markdown typically doesn't get rendered if nested within another HTML element.  If a parent
            // element other than the document is found, use the fallback HTML element instead.
