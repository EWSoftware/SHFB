...
// File    : CodeSnippetGroupElementTabbed.cs
// Author  : Eric Woodruff  (Eric@EWoodruff.us)
// Updated : 11/22/2025
// Note    : Copyright 2022-2025, Eric Woodruff, All rights reserved
//
// This file contains the class used to handle codeSnippetGroup elements in legacy presentation styles such as
...
public class CodeSnippetGroupElementTabbed : Element
{
    ...
    /// <inheritdoc />
    public CodeSnippetGroupElementTabbed() : base("codeSnippetGroup", true)
    {
    }
    #endregion
                ...
                foreach(var snippet in snippets)
                {
                    ...
                    else
                    {
                        ...
                        tab.Add(new XElement("a",
                            new XAttribute("href", "#"),
                            new XAttribute("onclick", $"ChangeTab('{id}','{snippet.Attribute("style")?.Value}','{position}','{nodeCount}');return false;"),
