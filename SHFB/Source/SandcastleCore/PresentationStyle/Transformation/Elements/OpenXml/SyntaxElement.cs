...
//    Date     Who  Comments
// ==============================================================================================================
// 05/31/2022  EFW  Created the code
//===============================================================================================================
...
/// </summary>
public class SyntaxElement : OpenXmlElement
{
    ...
    public SyntaxElement(string baseSourceCodeUrlArgName) : base("syntax", true)
    {
    ...
    private static void RenderSyntaxSections(TopicTransformationCore transformation, XElement element, XElement content)
    {
        ...
        foreach(var div in codeDivs)
        {
            ...
            table.Add(new XElement(WordProcessingML + "tr",
            ...
            else
            {
                if(div.Attribute("codeLanguage").Value == "XAML")
                    RenderXamlSyntaxBlock(transformation, div, para);
                else
                    transformation.RenderChildElements(para, div.Nodes());
            }
