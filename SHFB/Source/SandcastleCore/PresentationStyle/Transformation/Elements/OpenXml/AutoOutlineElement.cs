...
public class AutoOutlineElement : OpenXmlElement
{
    ...
    public override void Render(TopicTransformationCore transformation, XElement element)
    {
        ...
        {
            InsertAutoOutlineFromMarkdown(transformation, intro != null ? null : element.Parent.Parent,
    ...
    private static void InsertAutoOutlineFromMarkdown(TopicTransformationCore transformation, XElement start,
