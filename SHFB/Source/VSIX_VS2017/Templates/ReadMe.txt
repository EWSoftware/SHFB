...
===============================
IMPORTANT: The files referred to in the project and item template elements must physically reside in the project
           folder structure.  They cannot be linked items.  Keep them in synch between the different VSIX
           projects.
...
6. Add the Microsoft.VisualStudio.ProjectTemplate and Microsoft.VisualStudio.ItemTemplate items to the Assets
