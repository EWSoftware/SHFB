...
//    Date     Who  Comments
// ==============================================================================================================
// 01/01/2013  EFW  Created the code
...
namespace Sandcastle.Tools.BuildComponents.Targets
{
    ...
    public sealed class ESentTargetDictionary : TargetDictionary
    {
        ...
        private readonly PersistentDictionary<string, Target> index;
          ...
          base(component, configuration)
        {
            ...
            if(String.IsNullOrWhiteSpace(cachePath))
                throw new ArgumentException("The cachePath attribute must contain a value", nameof(configuration));
            ...
            // conceptual build.
            if(!String.IsNullOrWhiteSpace(noReloadValue) && Boolean.TryParse(noReloadValue, out bool noReload) &&
