...
{
    /// <summary>
    /// This form is used to configure the syntax generators for the <see cref="SyntaxComponent"/>
    /// </summary>
    public partial class SyntaxComponentConfigDlg : Window
    {
        ...
        private BindingList<SyntaxGeneratorSettings> syntaxGenerators;
        ...
        public SyntaxComponentConfigDlg(string currentConfig, CompositionContainer container)
        {
