...
namespace Sandcastle.Tools.BuildComponents.UI
{
    ...
    /// </summary>
    public partial class ESentReflectionIndexConfigDlg : Window
    {
        ...
        /// </summary>
        [ConfigurationEditorExport("Reflection Index Data (ESENT Cache)")]
        public sealed class ReflectionIndexDataFactory : IConfigurationEditor
        {
            ...
            {
                var dlg = new ESentReflectionIndexConfigDlg(configuration);
        ...
        public ESentReflectionIndexConfigDlg(XElement configuration)
        {
            InitializeComponent();
            ...
            chkEnableLocalCache.IsChecked = !String.IsNullOrWhiteSpace((string)node.Attribute("projectCachePath"));
        ...
        private void btnOK_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                txtFrameworkIndexCachePath.SetValidationState(false, "The Framework reflection index cache path " +
                    "is required");
                isValid = false;
            }
            else
            {
                ...
                {
                    txtFrameworkIndexCachePath.SetValidationState(false, "The Framework reflection index cache " +
                        "path must be unique");
                    isValid = false;
                }
            }
            ...
            {
                txtProjectIndexCachePath.SetValidationState(false, "The project reflection index cache path is " +
                    "required if enabled");
                isValid = false;
            }
