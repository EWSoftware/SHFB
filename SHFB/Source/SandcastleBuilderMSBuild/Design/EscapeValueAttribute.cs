...
namespace SandcastleBuilder.MSBuild.Design
{
    ...
    public sealed class EscapeValueAttribute : Attribute
    {
        ...
        private static readonly Regex reUnescape = new("%[0-9a-f]{2}", RegexOptions.IgnoreCase);

        private static readonly MatchEvaluator onEscapeMatch = new(OnEscapeMatch);
        ...
        {
            string escaped = WebUtility.HtmlEncode(unescapedValue ?? String.Empty);
