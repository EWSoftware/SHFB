...
public class MarkdownTransformation : TopicTransformationCore
{
    ...
    protected override void CreateElementHandlers()
    {
        ...
        [
            ...
            new MarkdownElement("h1", "# ", null, "h1", true),
            new MarkdownElement("h2", "## ", null, "h2", true),
            new MarkdownElement("h3", "### ", null, "h3", true),
            new MarkdownElement("h4", "#### ", null, "h4", true),
            new MarkdownElement("h5", "##### ", null, "h5", true),
            new MarkdownElement("h6", "###### ", null, "h6", true),
            new PassthroughElement("header", true),
            new MarkdownElement("hr", "---", null, "hr", true),
            new MarkdownElement("i", "*", "*", "em"),
            new PassthroughElement("iframe"),
            new PassthroughElement("img"),
            new PassthroughElement("input"),
            new MarkdownElement("ins", "++", "++", "ins"),
            ...
            new MarkdownElement("sub", "~", "~", "sub"),
            new MarkdownElement("sup", "^", "^", "sup"),
            ...
            new CodeInlineElement("span", "code"),      // This will actually render in markdown format (`code`) for general keywords
