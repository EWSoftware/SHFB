...
// Ignore Spelling: fa resizer github
...
/// presentation style.
/// </summary>
public class Themed2026Transformation : TopicTransformationCore
{
    #region Private data members
    //=====================================================================

    private XDocument pageTemplate;
    private readonly Themed2026PresentationStyle presentationStyle;
    ...
    public Themed2026Transformation(Themed2026PresentationStyle presentationStyle) :
    ...
    /// Project URL
    /// </summary>
    private string ProjectUrl => this.TransformationArguments[nameof(ProjectUrl)].Value;
    ...
    protected override void CreateTransformationArguments()
    {
        ...
        [
            ...
            new TransformationArgument(nameof(ProjectUrl), true, true, null,
                "An optional project URL for a link in the page header."),
    ...
    protected override void CreateElementHandlers()
    {
        ...
        [
            ...
            new PassthroughElement("code", true) { DoNotParse = true },
            ...
            new PassthroughElement("h1", true),
            new PassthroughElement("h2", true),
            new PassthroughElement("h3", true),
            new PassthroughElement("h4", true),
            new PassthroughElement("h5", true),
            new PassthroughElement("h6", true),
            new PassthroughElement("header", true),
            new PassthroughElement("hr", true),
            new PassthroughElement("i"),
            new PassthroughElement("iframe"),
            new PassthroughElement("img"),
            new PassthroughElement("input"),
            ...
            new MarkupElement(),
            new ConvertibleElement("para", "p", true, true),
            ...
            new CodeInlineElement("span", "code"),
            ...
            new ConvertibleElement("definitionTable", "dl", false, true),
            ...
            new ConvertibleElement("row", "tr", false, true),
            new SectionElement(),
            ...
            new ConvertibleElement("tableHeader", "thead", false, true),
    ...
    {
        string sectionId = uniqueId + "Section";
        ...
        else
        {
            ...
            // TODO: Remove script for SectionExpandCollapse and SectionExpandCollapseCheckKey
            ...
            titleElement = new XElement($"h{headingLevel}", titleContent);

            if(!String.IsNullOrWhiteSpace(linkId))
                titleElement.Add(new XAttribute("id", linkId));
        }

        var contentElement = new XElement("div", new XAttribute("id", sectionId));
        ...
        if(projectLinkContainer != null)
        {
            if(!String.IsNullOrWhiteSpace(this.ProjectUrl))
            {
                projectLinkContainer.Add(new XElement("a",
                    ...
                    new XElement("span", new XAttribute("class", "icon"),
                        new XElement("i", new XAttribute("class",
                            this.ProjectUrl.IndexOf("github.com", StringComparison.OrdinalIgnoreCase) != -1 ?
      ...
      XElement content)
    {
        ...
        int maxVersionParts = ((Themed2026Transformation)transformation).MaxVersionParts;
    ...
    private static void RenderApiEnumerationMembersList(TopicTransformationCore transformation)
    {
        ...
        var thisTransform = (Themed2026Transformation)transformation;
            ...
            ApiMemberGroup.ExplicitInterfaceImplementation, ApiMemberGroup.Overload })
        {
                ...
                el => el.Element("templates")?.Elements()?.Count() ?? 0))
            {
                XElement referenceLink = new("referenceLink",
                        new XAttribute("target", e.Attribute("api").Value));
                string showParameters = (!((Themed2026Transformation)transformation).ShowParametersOnAllMethods &&
