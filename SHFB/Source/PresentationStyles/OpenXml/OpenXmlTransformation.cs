...
public class OpenXmlTransformation : TopicTransformationCore
{
    ...
    protected override void CreateElementHandlers()
    {
        ...
        [
            ...
            new NonRenderedParentElement("address"),
            ...
            new StyledParagraphElement("blockquote", "Quote", true),
            new LineBreakElement("br"),
            new NonRenderedParentElement("canvas"),
            new NonRenderedParentElement("col"),
            new NonRenderedParentElement("colgroup"),
            ...
            new NonRenderedParentElement("dfn"),
            ...
            new NonRenderedParentElement("fieldset"),
            new NonRenderedParentElement("figcaption"),
            new FigureElement(),
            new NonRenderedParentElement("font"),
            new NonRenderedParentElement("footer"),
            new NonRenderedParentElement("form"),
            new NonRenderedParentElement("frame"),
            new NonRenderedParentElement("frameset"),
            new StyledParagraphElement("h1", "Heading1", true),
            new StyledParagraphElement("h2", "Heading2", true),
            new StyledParagraphElement("h3", "Heading3", true),
            new StyledParagraphElement("h4", "Heading4", true),
            new StyledParagraphElement("h5", "Heading5", true),
            new StyledParagraphElement("h6", "Heading6", true),
            new NonRenderedParentElement("header"),
            new HorizontalRuleElement(),
            new ConvertibleElement("i", "span", "Emphasis"),
            new NonRenderedParentElement("iframe"),
            new PassthroughElement("img"),
            new NonRenderedParentElement("input"),
            new NonRenderedParentElement("ins"),
            new NonRenderedParentElement("keygen"),
            new NonRenderedParentElement("legend"),
            // The Open XML file builder will convert lists accordingly
            new ConvertibleElement("li", "li", false, true),
            ...
            // The Open XML file builder will convert lists accordingly
            new ConvertibleElement("ol", "ul", "ordered", true),
            new NonRenderedParentElement("optgroup"),
            new NonRenderedParentElement("option"),
            ...
            new IgnoredElement("script") { DoNotParse = true },
            new NonRenderedParentElement("search"),
            new NonRenderedParentElement("select"),
            new NonRenderedParentElement("source"),
            new ConvertibleElement("strong", "span", "Bold"),
            new IgnoredElement("style") { DoNotParse = true },
            ...
            new IgnoredElement("textarea") { DoNotParse = true },
            ...
            // The Open XML file builder will convert lists accordingly
            new ConvertibleElement("ul", "ul", "bullet", true),
            ...
            // type (API or MAML).
            new PassthroughElement("artLink"),
            ...
            new CodeInlineElement("span", "CodeInline"),
            new NonRenderedParentElement("codeReference") { DoNotParse = true },
    ...
    public override void RenderTextNode(XElement content, XText textNode)
    {
        ...
        {
            XElement t = new(OpenXmlElement.WordProcessingML + "t", new XAttribute(Element.XmlSpace, "preserve")),
                run = new(OpenXmlElement.WordProcessingML + "r", t);
      ...
      string title, string linkId, int headingLevel)
    {
        ...
        else
        {
            ...
            titleElement = new XElement(OpenXmlElement.WordProcessingML + "p",
                new XElement(OpenXmlElement.WordProcessingML + "pPr",
                    new XElement(OpenXmlElement.WordProcessingML + "pStyle",
                        new XAttribute(OpenXmlElement.WordProcessingML + "val", $"Heading{headingLevel}"))),
                titleContent);
    ...
    private static void RenderNotices(TopicTransformationCore transformation)
    {
        ...
        foreach(var n in transformation.NoticeDefinitions)
        {
            ...
            if(!String.IsNullOrWhiteSpace(noticeText))
            {
                var message = new XElement(OpenXmlElement.WordProcessingML + "t");
            ...
            transformation.CurrentElement.Add(new XElement(OpenXmlElement.WordProcessingML + "p",
                new XElement(OpenXmlElement.WordProcessingML + "r",
                    new XElement(OpenXmlElement.WordProcessingML + "rPr",
                        new XElement(OpenXmlElement.WordProcessingML + "b")), n)));
        }
    }
       ...
       XElement parent)
    {
        ...
        foreach(var n in transformation.NoticeDefinitions)
        {
            ...
            if(!String.IsNullOrWhiteSpace(noticeText))
            {
                var tag = new XElement(OpenXmlElement.WordProcessingML + "t");
        ...
        if(notices.Count != 0)
        {
            if(!parent.IsEmpty)
            {
                parent.Add(new XElement(OpenXmlElement.WordProcessingML + "r",
    ...
    private static void RenderApiRootList(TopicTransformationCore transformation)
    {
        ...
        var (title, _) = transformation.CreateSection(elements[0].GenerateUniqueId(), true, "title_namespaces",
            null, 0);

        transformation.CurrentElement.Add(title);

        XElement table = new(OpenXmlElement.WordProcessingML + "tbl",
            new XElement(OpenXmlElement.WordProcessingML + "tblPr",
                new XElement(OpenXmlElement.WordProcessingML + "tblStyle",
    ...
    private static void RenderApiTypeMemberLists(TopicTransformationCore transformation)
    {
            ...
            ApiMemberGroup.ExplicitInterfaceImplementation, ApiMemberGroup.Overload })
        {
            ...
            var (title, _) = transformation.CreateSection(members.First().GenerateUniqueId(), true,
                "tableTitle_" + memberType.ToString(), null, 0);
                ...
                el => el.Element("templates")?.Elements()?.Count() ?? 0))
            {
                XElement referenceLink = new("referenceLink",
                        new XAttribute("target", e.Attribute("api").Value));
                string showParameters = (!((OpenXmlTransformation)transformation).ShowParametersOnAllMethods &&
    ...
    private static void RenderApiSeeAlsoSection(TopicTransformationCore transformation)
    {
          ...
          transformation.ApiMember.ApiTopicGroup == ApiMemberGroup.List)
        {
            ...
            var (title, _) = transformation.CreateSection("seeAlso", true, "title_relatedTopics", null, 0);
