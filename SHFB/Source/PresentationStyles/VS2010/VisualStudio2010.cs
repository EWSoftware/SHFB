...
namespace Sandcastle.PresentationStyles.VS2010
{
    /// <summary>
    ...
    [PresentationStyleExport("VS2010", "VS2010", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "This style is similar to the one used for offline " +
      "content in Microsoft Help Viewer in Visual Studio 2010.")]
    public sealed class VisualStudio2010PresentationStyle : PresentationStyleSettings
    {
        /// <inheritdoc />
        ...
        /// Constructor
        /// </summary>
        public VisualStudio2010PresentationStyle()
        {
