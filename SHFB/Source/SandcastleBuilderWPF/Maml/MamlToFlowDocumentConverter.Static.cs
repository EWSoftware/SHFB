...
public partial class MamlToFlowDocumentConverter
{
    ...
    #region Heading style names
    //=====================================================================

    private static readonly string[] headingStyles = [ NamedStyle.Heading1, NamedStyle.Heading2,
        NamedStyle.Heading3, NamedStyle.Heading4, NamedStyle.Heading5, NamedStyle.Heading6 ];
    ...
    // Tasks
    private static readonly Guid HowToId = new("DAC3A6A0-C863-4E5B-8F65-79EFC6A4BA09");
    private static readonly Guid WalkthroughId = new("4779DD54-5D0C-4CC3-9DB3-BF1C90B721B3");
    private static readonly Guid SampleId = new("069EFD88-412D-4E2F-8848-2D5C3AD56BDE");
    private static readonly Guid TroubleshootingId = new("38C8E0D1-D601-4DBA-AE1B-5BEC16CD9B01");

    // Reference
    private static readonly Guid ReferenceWithoutSyntaxId = new("F9205737-4DEC-4A58-AA69-0E621B1236BD");
    private static readonly Guid ReferenceWithSyntaxId = new("95DADC4C-A2A6-447A-AA36-B6BE3A4F8DEC");
    private static readonly Guid XmlReferenceId = new("3272D745-2FFC-48C4-9E9D-CF2B2B784D5F");
    private static readonly Guid ErrorMessageId = new("A635375F-98C2-4241-94E7-E427B47C20B6");
    private static readonly Guid UIReferenceId = new("B8ED9F21-39A4-4967-928D-160CD2ED9DCE");
    
    // Concepts
    private static readonly Guid ConceptualId = new("1FE70836-AA7D-4515-B54B-E10C4B516E50");
    private static readonly Guid SdkTechnologyOverviewArchitectureId = new("68F07632-C4C5-4645-8DFA-AC87DCB4BD54");
    private static readonly Guid SdkTechnologyOverviewCodeDirectoryId = new("4BBAAF90-0E5F-4C86-9D31-A5CAEE35A416");
    private static readonly Guid SdkTechnologyOverviewScenariosId = new("356C57C4-384D-4AF2-A637-FDD6F088A033");
    private static readonly Guid SdkTechnologyOverviewTechnologySummaryId = new("19F1BB0E-F32A-4D5F-80A9-211D92A8A715");
    
    // Other resources
    private static readonly Guid OrientationId = new("B137C930-7BF7-48A2-A329-3ADCAEF8868E");
    private static readonly Guid WhitePaperId = new("56DB00EC-28BA-4C0D-8694-28E8B244E236");
    private static readonly Guid CodeEntityId = new("4A273212-0AC8-4D72-8349-EC11CD2FF8CD");
    private static readonly Guid GlossaryId = new("A689E19C-2687-4881-8CE1-652FF60CF46C");
    private static readonly Guid SDKTechnologyOverviewOrientationId = new("CDB8C120-888F-447B-8AF8-F9540562E7CA");
    ...
    private static readonly Dictionary<string, Action<ElementProperties>> elementHandlers = new()
    {
        ...
        { "xmlEntityReference", BoldElement },  // XSD build component extension element (https://github.com/terrajobst/xsddoc)
        ...
        // Html elements.  These may be seen in Markdown files converted to MAML
        { "a", AnchorLinkElement },
        { "abbr", UnderlineElement },
        { "acronym", UnderlineElement },
        { "address", SectionElement },
        { "area", IgnoredElement },
        { "article", SectionElement },
        { "artLink", ImageElement },
        { "aside", SectionElement },
        { "audio", IgnoredElement },
        { "b", BoldElement },
        { "bdi", IgnoredElement },
        { "blockquote", QuoteElement },
        { "br", LineBreakElement },
        { "canvas", IgnoredElement },
        { "col", IgnoredElement },
        { "colgroup", IgnoredElement },
        { "datalist", IgnoredElement },
        { "dd", DefinitionElement },
        { "del", StrikethroughElement },
        { "details", IgnoredElement },
        { "dfn", IgnoredElement },
        { "dialog", IgnoredElement },
        { "div", SectionElement },
        { "dl", IgnoredElement },
        { "dt", DefinedTermElement },
        { "em", ItalicElement },
        { "embed", IgnoredElement },
        { "fieldset", IgnoredElement },
        { "figcaption", FigureCaptionElement },
        { "figure", FigureElement },
        { "font", IgnoredElement },
        { "footer", SectionElement },
        { "form", IgnoredElement },
        { "frame", IgnoredElement },
        { "frameset", IgnoredElement },
        // h1-h6 won't be seen as they are converted to section elements
        { "header", SectionElement },
        { "hr", IgnoredElement },
        { "i", ItalicElement },
        { "iframe", IgnoredElement },
        { "img", ImageElement },
        { "input", IgnoredElement },
        { "ins", UnderlineElement },
        { "keygen", IgnoredElement },
        { "legend", IgnoredElement },
        { "li", ListItemElement },
        { "main", IgnoredElement },
        { "map", IgnoredElement },
        { "mark", BoldElement },
        { "meter", IgnoredElement },
        { "nav", IgnoredElement },
        { "ol", ListElement },
        { "optgroup", IgnoredElement },
        { "option", IgnoredElement },
        { "output", IgnoredElement },
        { "p", ParagraphElement },
        { "pre", CodeElement },
        { "progress", IgnoredElement },
        { "q", ItalicElement },
        { "rp", IgnoredElement },
        { "rt", IgnoredElement },
        { "ruby", IgnoredElement },
        { "script", IgnoredElement },
        { "search", IgnoredElement },
        { "select", IgnoredElement },
        { "source", IgnoredElement },
        { "span", IgnoredElement },
        { "strong", BoldElement },
        { "style", IgnoredElement },
        { "sub", SubscriptElement },
        { "sup", SuperscriptElement },
        { "svg", IgnoredElement },
        { "tbody", IgnoredElement },
        { "td", EntryElement },
        { "textarea", IgnoredElement },
        { "tfoot", RowElement },
        { "th", EntryElement },
        { "thead", TableHeaderElement },
        { "time", IgnoredElement },
        { "tr", RowElement },
        { "track", IgnoredElement },
        { "u", UnderlineElement },
        { "ul", ListElement },
        { "video", IgnoredElement },
        { "wbr", IgnoredElement }
    };
    #endregion
}
