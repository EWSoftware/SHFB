    ...
    public class OpenXmlFileGenerator
    {
        ...
        private void ApplyListFormatting(XElement list, int level)
        {
            ...
            foreach(var listItem in list.Elements("li").ToList())
            {
                ...
                var listParas = listItem.Elements(w + "p");
                int paraCount = listParas.Count();
                ...
                foreach(var para in listItem.Elements(w + "tbl"))
                {
                    ...
                    if(indent == null)
                    {
                        var insertLocation = props.Element(w + "tblW");

                        if(insertLocation == null)
                        {
                            insertLocation = props.Element(w + "pStyle");

                            if(insertLocation == null)
                                insertLocation = props.Elements().First();
                        }
