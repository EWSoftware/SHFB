...
namespace SandcastleBuilder.Utils.BuildEngine
{
    ...
    internal class BuildAssemblerInternal : IBuildAssembler, IDisposable
    {
        ...
        private readonly BlockingCollection<(MessageLevel Level, string Message)> messageLog =
            new BlockingCollection<(MessageLevel Level, string Message)>();
        ...
        public void BuildTopics()
        {
            ...
            Task.WaitAll(new[] { builder, logger}, currentBuild.CancellationToken);
        }
