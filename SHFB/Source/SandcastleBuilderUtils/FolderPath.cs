...
// 06/23/2008  EFW  Reworked BasePath support to make it usable in a multi-project environment like Visual Studio
//===============================================================================================================
...
namespace SandcastleBuilder.Utils
{
    ...
    /// </summary>
    [Serializable, TypeConverter(typeof(FolderPathTypeConverter))]
    public class FolderPath : FilePath
    {
        ...
        public override string Path
        {
            ...
            set
            {
                ...
                if(base.Path.Length != 0 && !IsPathTerminated(this.ToString()))
                    base.Path += IOPath.DirectorySeparatorChar;
            }
        }
        ...
        /// used for making changes to the expanded path if needed.  The <see cref="FilePath.PersistablePath"/>
