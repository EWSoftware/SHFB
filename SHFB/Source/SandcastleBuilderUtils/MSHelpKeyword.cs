...
namespace SandcastleBuilder.Utils
{
    ...
    public class MSHelpKeyword : IComparable<MSHelpKeyword>, INotifyPropertyChanged
    {
        ...
        private static readonly string[] validIndexNames = new[] { "K", "F" };

        private static readonly Dictionary<string, string> indexNamesDataSource = new Dictionary<string, string>
        {
            { "K", "Keyword" },
            { "F", "F1 Help" }
        };
