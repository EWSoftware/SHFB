...
{
    /// <summary>
    /// This class is used to parse project information out of solution files (.sln or .slnx)
    /// </summary>
    ...
    public class SolutionFile
    {
        ...
        private static readonly HashSet<string> projectFileExtension = new HashSet<string>(
            new[] { ".csproj", ".fsproj", ".vbproj", ".vcproj", ".vcxproj", ".wapproj" }, StringComparer.OrdinalIgnoreCase);
        ...
        public SolutionFile(string solutionFilename)
        {
            ...
            try
            {
                if(Path.GetExtension(solutionFilename).Equals(".sln", StringComparison.OrdinalIgnoreCase) ||
                  Path.GetExtension(solutionFilename).Equals(".txt", StringComparison.OrdinalIgnoreCase))
                {
