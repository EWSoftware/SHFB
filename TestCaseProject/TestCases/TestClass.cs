...
namespace TestDoc
{
    ...
    public class TestClass
    {
        ...
        /// </summary>
        private readonly string privateStringField;

        // Undocumented private static field
        private static readonly string privateStaticField;
        #endregion
        ...
        /// </summary>
        internal string InternalProperty => internalStringField;

        /// <summary>
        /// A protected internal property
        /// </summary>
        protected internal string ProtectedInternalProperty => protectedInternalStringField;

        /// <summary>
        /// A private property
        /// </summary>
        private string PrivateProperty => privateStringField;
        ...
        */
        ...
        public virtual string PublicMethod()
        {
            ...
            CancelableEvent?.Invoke(this, new CancelEventArgs());
        ...
        public System.Collections.ObjectModel.Collection<System.ServiceModel.Syndication.SyndicationPerson> Authors => null;
        ...
        /// </remarks>
        public IEnumerable<string> Queries => null;
        ...
        /// </remarks>
        public IEnumerable<System.ServiceModel.Syndication.SyndicationItem> ItemsRaw => null;
    ...
    public class TestDerivedClass : TestClass
    {
        ...
        /// </remarks>
        /// <example>
        /// <code source="..\TestCases\TestClass.cs" region="Methods"
        ...
        /// <see cref="TestThis{T,K}(KeyValuePair{T, K}, Int64)"/>
    ...
    public sealed class TestSealedDerivedClass : TestDerivedClass
    {
        ...
        public override string PublicProperty
        {
            get => base.PublicProperty; set => base.PublicProperty = value;
        }
        ...
        /// </summary>
        /// <returns>String</returns>
        /// <include file='..\TestCaseDocs\ExampleFiles\Example.xml' path='Test/Example[@id="1"]/*' />
        protected override string ProtectedMethod()
        {
            return base.ProtectedMethod();
        }
